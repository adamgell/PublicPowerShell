...
$officeInstall = "$($env:ProgramData)\Microsoft\OfficeInstall\OfficeInstall.ps1.tag"
$checkOfficeInstall = Test-Path -Path $officeInstall


$LogFileName = "M365AppsSetupDetect.log"
...
if ($M365AppsCheck -and $checkOfficeInstall) {
