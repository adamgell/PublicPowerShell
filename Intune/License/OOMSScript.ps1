##
# Rudy Ooms https://call4cloud.nl/2024/05/kb5036980-breaks-upgrade-windows11-enterprise/
# Script to enable the MFA requirement in ClipRenew for Windows 11 Enterprise
